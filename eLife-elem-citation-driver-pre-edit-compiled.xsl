...
<!--PROLOG-->
   ...
   <xsl:template match="element-citation" priority="105" mode="M2">
      ...
      <xsl:if test="count(year)&gt;1 ">
         <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                      xmlns:osf="http://www.oxygenxml.com/sch/functions">
            <xsl:text>Error:</xsl:text>
            <xsl:text>[err-elem-cit-gen-date-1-9] There may be at most one &lt;year&gt; element. Reference '</xsl:text>
            <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="ancestor::ref/@id"/>
   ...
   <xsl:template match="element-citation/year" priority="101" mode="M2">
      ...
      <xsl:if test="some $x in (preceding::year)       satisfies (((count(ancestor::element-citation/person-group[1]/*)=1 and        count($x/ancestor::element-citation/person-group[1]/*)=1) and        ((ancestor::element-citation/person-group[1]/name[1]/surname and        concat($x,'+',$x/ancestor::element-citation/person-group[1]/name[1]/surname)       = concat(current(),'+',ancestor::element-citation/person-group[1]/name[1]/surname))       or       (ancestor::element-citation/person-group[1]/collab[1] and        concat($x,'+',$x/ancestor::element-citation/person-group[1]/collab[1])       = concat(current(),'+',ancestor::element-citation/person-group[1]/collab[1]))))       or ((count(ancestor::element-citation/person-group[1]/*) ge 3 and        count($x/ancestor::element-citation/person-group[1]/*) ge 3)  and        ((ancestor::element-citation/person-group[1]/name[1]/surname and        concat($x,'+',$x/ancestor::element-citation/person-group[1]/name[1]/surname)       = concat(current(),'+',ancestor::element-citation/person-group[1]/name[1]/surname))       or       (ancestor::element-citation/person-group[1]/collab[1] and        concat($x,'+',$x/ancestor::element-citation/person-group[1]/collab[1])       = concat(current(),'+',ancestor::element-citation/person-group[1]/collab[1]))))       or       ((count(ancestor::element-citation/person-group[1]/*)=2 and        count($x/ancestor::element-citation/person-group[1]/*)=2)  and        ((ancestor::element-citation/person-group[1]/name[1]/surname=$x/ancestor::element-citation/person-group[1]/name[1]/surname       and       (ancestor::element-citation/person-group[1]/name[2]/surname=$x/ancestor::element-citation/person-group[1]/name[2]/surname       or       ancestor::element-citation/person-group[1]/*[2]=$x/ancestor::element-citation/person-group[1]/*[2]))       or       (ancestor::element-citation/person-group[1]/*[1]=$x/ancestor::element-citation/person-group[1]/*[1]       and       (ancestor::element-citation/person-group[1]/name[2]/surname=$x/ancestor::element-citation/person-group[1]/name[2]/surname       or       ancestor::element-citation/person-group[1]/*[2]=$x/ancestor::element-citation/person-group[1]/*[2])))       and $x=current())       )">
         <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                      xmlns:osf="http://www.oxygenxml.com/sch/functions">
            <xsl:text>Error:</xsl:text>
            <xsl:text>[err-elem-cit-gen-date-1-8] Letter suffixes must be unique for the combination of year and author information. Reference '</xsl:text>
            <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="ancestor::ref/@id"/>
   ...
   <xsl:template match="ref" priority="103" mode="M4">
      ...
      <xsl:variable name="preceding-name2"
      ...
      <xsl:variable name="year-paren" select="' \(\d{4}\w?\)$'"/>
		    ...
		    <!--ASSERT error-->
      <xsl:choose>
         <xsl:when test="every $x in //xref[@rid=current()/@id]       satisfies (       if (count(current()/element-citation/person-group[1]/(name | collab))=1)        then (       matches(normalize-space($x), concat('^', current()/element-citation/person-group[1]/name/surname, $year-comma))       or       matches(normalize-space($x), concat('^', current()/element-citation/person-group[1]/name/surname, $year-paren))       or       matches(normalize-space($x), concat('^', current()/element-citation/person-group[1]/collab, $year-comma))       or       matches(normalize-space($x), concat('^', current()/element-citation/person-group[1]/collab, $year-paren))       )       else        if (count(current()/element-citation/person-group[1]/(name|collab))=2)        then (       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,       ' and ', current()/element-citation/person-group[1]/name[2]/surname, $year-comma))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,       ' and ', current()/element-citation/person-group[1]/name[2]/surname, $year-paren))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,       ' and ', current()/element-citation/person-group[1]/collab[1], $year-comma))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,       ' and ', current()/element-citation/person-group[1]/collab[1], $year-paren))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],       ' and ', current()/element-citation/person-group[1]/name[1]/surname, $year-comma))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],       ' and ', current()/element-citation/person-group[1]/name[1]/surname, $year-paren))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],       ' and ', current()/element-citation/person-group[1]/collab[2], $year-comma))       or       matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],       ' and ', current()/element-citation/person-group[1]/collab[2], $year-paren))       )       else        if (count(current()/element-citation/person-group[1]/(name|collab))&gt;2)        then (if (local-name(current()/element-citation/person-group[1]/*[1])='name')             then (matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,             ' et al.', $year-comma))             or             matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/name[1]/surname,             ' et al.', $year-paren)))             else (matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],             ' et al.', $year-comma))             or             matches(replace($x,'\p{Zs}',' '), concat('^', current()/element-citation/person-group[1]/collab[1],             ' et al.', $year-paren)))       )          else ()       )"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                         xmlns:osf="http://www.oxygenxml.com/sch/functions">
               <xsl:text>Error:</xsl:text>
               <xsl:text> </xsl:text>
               <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="$name"/>
		    ...
		    <!--ASSERT error-->
      <xsl:choose>
         <xsl:when test="every $x in //xref[@rid=current()/@id]       satisfies (matches(replace($x,'\p{Zs}',' '), concat(', ',current()/element-citation/year[1]),'s') or       matches(replace($x,'\p{Zs}',' '), concat('\(',current()/element-citation/year[1],'\)')))"/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                         xmlns:osf="http://www.oxygenxml.com/sch/functions">
               <xsl:text>Error:</xsl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                         xmlns:osf="http://www.oxygenxml.com/sch/functions">
               <xsl:text>Warning:</xsl:text>
               <xsl:text>[warning-elem-cit-journal-9-2] Reference '</xsl:text>
               <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="ancestor::ref/@id"/>
               <xsl:text>' does not have a pub-id with pub-id-type 'doi', and the source is not on the list of journals that do not have DOIs. Check for the missing DOI for this reference: &lt;source&gt; '</xsl:text>
   ...
   <xsl:template match="element-citation[@publication-type='book']"
      ...
      <xsl:if test="(lpage or fpage) and not(chapter-title)">
         <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
		    ...
		    <!--REPORT error-->
      <xsl:if test="(lpage and fpage) and (fpage ge lpage[1])">
         <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                      xmlns:osf="http://www.oxygenxml.com/sch/functions">
            <xsl:text>Error:</xsl:text>
      ...
      <xsl:if test="count(lpage) &gt; 1 or count(fpage) &gt; 1">
         <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                      xmlns:osf="http://www.oxygenxml.com/sch/functions">
            <xsl:text>Error:</xsl:text>
            <xsl:text>[err-elem-cit-book-36-6] At most one &lt;lpage&gt; and one &lt;fpage&gt; are allowed. Reference '</xsl:text>
            <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="ancestor::ref/@id"/>
            <xsl:text>' has </xsl:text>
            <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="count(lpage)"/>
   ...
   <xsl:template match="element-citation[@publication-type='web']/date-in-citation"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT error-->
      <xsl:choose>
         <xsl:when test="(string-length(@iso-8601-date) &gt; 4) and format-date(xs:date(@iso-8601-date), '[MNn] [D], [Y]')=."/>
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                         xmlns:osf="http://www.oxygenxml.com/sch/functions">
               <xsl:text>Error:</xsl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron"
                         xmlns:osf="http://www.oxygenxml.com/sch/functions">
               <xsl:text>Error:</xsl:text>
               <xsl:text>[err-elem-cit-confproc-16-2] The only allowed pub-id types are 'doi' or 'pmid'. Reference '</xsl:text>
               <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="ancestor::ref/@id"/>
               <xsl:text>' has a pub-id type of '</xsl:text>
               <xsl:value-of xmlns="http://purl.oclc.org/dsdl/schematron" select="@pub-id-type"/>
               <xsl:text>'.</xsl:text>
